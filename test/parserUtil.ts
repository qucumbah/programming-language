 ...
 */
export function compareModuleParsingResult(
  sample: string,
 ...
 * @param log whether to log the generated AST
 */
export function compareFunctionParsingResult(
  sample: string,
  expectedAstStructure: any,
  log?: boolean,
): void {
 ...
 * @param log whether to log the generated AST
 */
export function compareArgumentParsingResult(
  sample: string,
  expectedAstStructure: any,
  log?: boolean,
): void {
  return compareParsingResult(
    parseParameterDeclaration,
    sample,
 ...
 * @param log whether to log the generated AST
 */
export function compareExpressionParsingResult(
  sample: string,
  expectedAstStructure: any,
  log?: boolean,
): void {
 ...
 * @param log whether to log the generated AST
 */
export function compareStatementParsingResult(
  sample: string,
  expectedAstStructure: any,
  log?: boolean,
): void {
